...
public class PacketReader extends com.github.unldenis.helper.npc.PacketReader {
    ...
    public PacketReader(@NonNull JavaPlugin plugin) {
        super(plugin);
        Events.subscribe(PlayerQuitEvent.class).handler(e->uninject(e.getPlayer())).bindWith(plugin);
        Events.subscribe(PlayerJoinEvent.class).handler(e->inject(e.getPlayer())).bindWith(plugin);
    }
